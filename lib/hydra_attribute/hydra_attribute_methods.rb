module HydraAttribute
  ...
  # See HydraAttribute::HydraAttributeMethods::ClassMethods for documentation.
  module HydraAttributeMethods
    ...
    module ClassMethods
      ...
      # Returns prepared <tt>ActiveRecord::Relation</tt> object with preloaded attributes for current entity.
      # This method is cacheable, so just one request per entity will be sent to the database.
      #
      ...
      # This method is cacheable per +identifier+.
      # It's better to use it instead of manually searching from <tt>hydra_attributes</tt> collection.
      #
